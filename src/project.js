            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function() {
                        i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(9), t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(8), t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(8), t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(7), t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(7), t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(7), t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(6, 9)), t.createFruitCount++))
                    }, .5))
